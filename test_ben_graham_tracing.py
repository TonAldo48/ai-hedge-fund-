...
def test_ben_graham_with_tracing():
    ...
    test_ticker = "KO"  # Use Coca-Cola as test case (classic value stock)
    ...
    print(f"   💭 Investment Style: classic_value_investing")
    ...
    try:
        ...
        if "analyst_signals" in result["data"] and "ben_graham_agent" in result["data"]["analyst_signals"]:
            ...
            if get_tracing_enabled():
                ...
                print(f"   Investment Style: classic_value_investing")
                print(f"   Key Metrics: P/E, P/B, debt/equity, current ratio, margin of safety")
